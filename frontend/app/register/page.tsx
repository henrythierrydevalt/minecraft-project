    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="minecraft-card p-4 md:p-6 lg:p-8 w-full max-w-md">
        <div className="text-center mb-6 md:mb-8">
          ...
          <p className="text-[#7cb342] text-sm md:text-base">Crie sua conta</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
          ...
          <div>
            <label className="block text-[#e0e0e0] font-bold mb-2 text-sm md:text-base">Nome de Usuário</label>
            <input
              type="text"
              value={username}
        ...
        <div className="mt-4 md:mt-6 text-center">
          <p className="text-[#888] text-sm md:text-base">
            Já tem conta?{' '}
            <Link href="/login" className="text-[#7cb342] font-bold hover:underline">
              Faça login
            </Link>
          </p>
        </div>
